...
describe('UserManagement Component', () => {
  ...
  describe('OnInit', () => {
    it('Should call load all on init', async () => {
      ...
      // THEN
      expect(axiosStub.get.calledWith(`api/users?sort=id,asc&page=0&size=20`)).toBeTruthy();
    });
  });
  ...
  describe('setActive', () => {
    it('Should update user and call load all', async () => {
      ...
      // THEN
      expect(axiosStub.put.calledWith(`api/users`, { id: 123, activated: true })).toBeTruthy();
      expect(axiosStub.get.calledWith(`api/users?sort=id,asc&page=0&size=20`)).toBeTruthy();
    });
  });
  ...
  describe('confirmDelete', () => {
    it('Should call delete service on confirmDelete', async () => {
      ...
      // THEN
      expect(axiosStub.delete.calledWith('api/users/' + 123)).toBeTruthy();
      expect(axiosStub.get.calledWith(`api/users?sort=id,asc&page=0&size=20`)).toBeTruthy();
    });
  });
